...
class Index extends React.Component{
    ...
    componentDidMount() {
        ...
        axios.get('http://playground.it266.com/article?token='+token)
            .then((response) => {
    ...
    deleteArticle=(id)=>{
        ...
        //ajax
        axios.post('http://playground.it266.com/article/delete?token='+this.state.token,qs.stringify(data))
            .then((response) => {
                alert(response.data.data)

                //重新获取数据
                axios.get('http://playground.it266.com/article?token='+this.state.token)
                    .then((response) => {
...
class Create extends Component {
    ...
    handleClick = () =>{
        ...
        //ajax
        axios.post('http://playground.it266.com/article/create?token='+token,qs.stringify(data))
            .then((response) => {
                alert(response.data.data)
...
class Edit extends Component {
    ...
    componentDidMount() {
        ...
        //ajax
        axios.get('http://playground.it266.com/article/detail?id='+id+'&token='+token)
            .then((response) => {
    ...
    handleClick = () =>{
        ...
        //ajax 成功之后跳转
        let data = {...this.state}
        axios.post('http://playground.it266.com/article/update?token='+token,qs.stringify(data))
            .then((response) => {
                alert(response.data.data)
                this.props.history.push("/article")
            })
